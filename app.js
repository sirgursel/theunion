...
app.post('/newsletter', contactController.newsletter);
...
app.get('/api/cobot', passportConfig.isAuthenticated, passportConfig.isAuthorized, apiController.getCobot);
 ...
 */
app.get('/auth/cobot', passport.authorize('cobot'));
app.get('/auth/cobot/callback', passport.authorize('cobot', { failureRedirect: '/api' }), (req, res) => {
  res.redirect('/api/cobot');
});
...
app.use(function(req, res, next){
  ...
  // respond with json
  if (req.accepts('json')) {
    res.send({ error: 'The page you requested could not be found' });
    return;
  }
